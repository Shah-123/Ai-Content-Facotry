...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth, height = 0.5\textheight,keepaspectratio]{Deployment Diagram.png}
...
\begin{itemize}
    \item \textbf{Scalable PostgreSQL Checkpointing:} For multi-tenant, high-concurrency enterprise deployments, the in-memory/local SQLite checkpointer will be replaced with a distributed \textbf{PostgreSQL} database backend using PGVector for semantic embedding storage.
